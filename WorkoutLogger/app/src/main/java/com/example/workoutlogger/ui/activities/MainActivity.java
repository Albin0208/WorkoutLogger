...
//                db.collection("exercises").get().addOnCompleteListener(exerciseTask -> {
//                    if (exerciseTask.isSuccessful()) {
//                        List<Exercise> exercises = new ArrayList<>();
//                        for (QueryDocumentSnapshot document : exerciseTask.getResult()) {
...
//
//                    } else {
//                        Log.d("MainActivity", "Error getting documents: ", exerciseTask.getException());
//                    }
//                });
//            } else {
